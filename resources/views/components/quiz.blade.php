<div class="flex-1 mt-8 ml-2 px-6 py-5 content-center border rounded">
    ...
    <div class="flex ml-2">
        <x-button class="flex-auto mt-2 mb-2 mr-2 ml-2" cta="Jane Austen" />
        <x-button class="flex-auto mt-2 mb-2 mr-2 ml-2" cta="Charlotte Bronté" />
        <x-button class="flex-auto mt-2 mb-2 mr-2 ml-2" cta="Albert Einstein" />
    </div>
</div>
