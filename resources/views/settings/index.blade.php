...
<div class="flex">
    ...
    <div class="w-full">
        ...
        <div class="flex">
            <div>
            <div class="mt-8 ml-2 px-6 py-5 content-center bg-white rounded">
                <h1 class="border-b-2 border-solid border-blue text-3xl font-bold pb-2">Profile</h1>
                <div class="flex mt-2 mt-2 mb-2">
            ...
            <div class="mt-8 ml-2 px-6 py-5 bg-white content-center rounded">
            ...
            <div class="flex justify-center mt-8 ml-2 px-6 py-5 content-center bg-white rounded">
                <div>
                    <h1 class="text-3xl font-bold pb-2">Personal Information</h1>
                    <div class="flex justify-center">
                    <img class="mt-8 inline-block rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                    </div>
                    <a class="flex justify-center mt-2" href="#">
